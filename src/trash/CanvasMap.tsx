...
const ZOOM_SENSITIVITY = 700; // bigger for lower zoom per scroll

export default function CanvasMap(props: CanvasProps) {
  ...
  useLayoutEffect(() => {
    ...
    mapImage.current.onload = () => {
      if (context) {
        ...
        context.drawImage(
          mapImage.current,
          // props.canvasWidth / 2 - mapSize / 2,
          // props.canvasHeight / 2 - mapSize / 2,
          // mapSize,
          // mapSize
          props.canvasWidth / 2 - mapSize / 2,
          props.canvasHeight / 2 - mapSize / 2,
